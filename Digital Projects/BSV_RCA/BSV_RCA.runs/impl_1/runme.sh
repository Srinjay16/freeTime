...
HD_PWD='C:/Users/SRINJAY/BSV_RCA/BSV_RCA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mkRCA4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mkRCA4.tcl -notrace
