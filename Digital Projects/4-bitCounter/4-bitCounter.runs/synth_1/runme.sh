...
HD_PWD='C:/Users/SRINJAY/4-bitCounter/4-bitCounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkCounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mkCounter.tcl
