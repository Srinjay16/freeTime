...
HD_PWD='C:/Users/SRINJAY/4-bitCounter/4-bitCounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mkCounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mkCounter.tcl -notrace
