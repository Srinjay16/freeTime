...
HD_PWD='C:/Users/SRINJAY/Full_adder/Full_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_top.tcl
