...
HD_PWD='C:/Users/SRINJAY/BSV_RCA/BSV_RCA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkRCA4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mkRCA4.tcl
