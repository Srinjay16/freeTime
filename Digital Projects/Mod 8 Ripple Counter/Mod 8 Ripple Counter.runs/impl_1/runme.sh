...
HD_PWD='C:/Users/SRINJAY/Mod 8 Ripple Counter/Mod 8 Ripple Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mod8RippleCounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mod8RippleCounter.tcl -notrace
