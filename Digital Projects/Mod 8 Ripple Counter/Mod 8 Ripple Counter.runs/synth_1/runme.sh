...
HD_PWD='C:/Users/SRINJAY/Mod 8 Ripple Counter/Mod 8 Ripple Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mod8RippleCounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mod8RippleCounter.tcl
