...
HD_PWD='C:/Users/SRINJAY/BSV_Fibonacci/BSV_Fibonacci.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkFibonacci.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mkFibonacci.tcl
