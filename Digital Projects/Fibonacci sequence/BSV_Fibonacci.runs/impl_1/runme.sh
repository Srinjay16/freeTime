...
HD_PWD='C:/Users/SRINJAY/BSV_Fibonacci/BSV_Fibonacci.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mkFibonacci.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mkFibonacci.tcl -notrace
