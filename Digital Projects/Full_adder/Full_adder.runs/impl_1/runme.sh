...
HD_PWD='C:/Users/SRINJAY/Full_adder/Full_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_adder_top.tcl -notrace
